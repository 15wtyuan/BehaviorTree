...
namespace BehaviorTree.Editors
{
    public class NodePrintController
    {
        ...
        public NodePrintController(VisualTask node)
        {
            ...
            if (_node.Task.GetType().GetCustomAttributes(typeof(TaskIconAttribute), true) is TaskIconAttribute[]
            ...
            _iconMain = new TextureLoader(iconPath);
        }
        ...
        private void PrintIcon()
        {
            ...
            var iconPadding = 0f;
            if (_node.Task.GetType().GetCustomAttributes(typeof(TaskIconPaddingAttribute), true) is
                    TaskIconPaddingAttribute[]
                    customAttributes && customAttributes.Length > 0)
            {
                iconPadding = customAttributes[0].IconPadding;
            }
